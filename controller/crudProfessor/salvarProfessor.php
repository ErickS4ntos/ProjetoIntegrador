<?php
    switch ($_REQUEST["acao"]) {
        case 'cadastrar':
            ...
            $sql = "INSERT INTO tb_professor (nome, email, senha) VALUES ('{$nome}', '{$email}', '{$senha}')";
            // conexao com banco
        ...
        case 'editar':
            ...
            $sql = "UPDATE tb_professor SET nome='{$nome}', email='{$email}', senha='{$senha}' WHERE id=".$_REQUEST["id"];
        ...
        case 'excluir':
            ...
            $sql = "DELETE FROM tb_professor WHERE id=".$_REQUEST["id"] ;
